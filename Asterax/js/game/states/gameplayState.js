...
define(['player', 'rock', 'rockGroupController', 'loadout', 'popupView', 'mainMenuView', 'gameplayView', 'hudView', 'Phaser'], function (Player, Rock, RockGroupController, Loadout, PopupView, MainMenuView, GameplayView, HUDView) {

    var module = function ()
    {
    };

    module.prototype = Object.create(Phaser.State.prototype);
